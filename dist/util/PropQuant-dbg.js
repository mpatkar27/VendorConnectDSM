...
sap.ui.define([
	...
	var PropQuant = function (oComponent, oTreeNode, oCollection, bEditable, udtprop, udtinst, proplist, oPropInfo, propindex) {
		PropBase.call(this, oComponent, "gramont.VCDSM.specedit.frag.PropQuant");
		
		this._subsec = this._byId("quantsubsec");
		...
		//2217
		var aCharHeaders = oCollection.getAdditional().parent.CompHeaderqnt;
		var cellinfo = oCollection.getAdditional();
		var comphead = this._byId("quant");
		...
		var _onChangeq = function (oEvent) {
	...
	PropQuant.prototype._onCharEdit = function (oCollection, oCharHeader, oEvent) { //FIXMEVC:refactor
	...
	PropQuant.prototype._onCharEditStore = function (oCharHeader, iInstanceIndex, oCollection, aCharValues, bNoUpdate) { // FIXMEVC: refactor
		oCollection.setFieldValue(iInstanceIndex, oCharHeader.getFieldName(), aCharValues, bNoUpdate);
	};

	PropQuant.prototype = Object.create(PropBase.prototype);
	PropQuant.prototype.constructor = PropQuant;

	PropQuant.prototype._formatEditMode = function (bAppEditMode) {
		var bEditMode = bAppEditMode && this._bEditable;
		return bEditMode;
	};
	PropQuant.prototype._infopop = function (oEvent) {
